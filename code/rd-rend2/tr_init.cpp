...
void GfxInfo_f( void ) 
{
	...
	//ri->Printf( PRINT_ALL, "GL_MAX_TEXTURE_UNITS_ARB: %d\n", glConfig.numTextureUnits ); /* FIXME, lazy */
...
//	Swap_Init();
	...
	ptr = (byte*)Z_Malloc( sizeof( *backEndData ) + sizeof(srfPoly_t) * max_polys + sizeof(polyVert_t) * max_polyverts, TAG_HUNKALLOC, qtrue);
...
qboolean RE_ProcessDissolve() { return qtrue; }
