...
qboolean QGL_Init( const char *dllname )
{
	...
	qglGenLists                  = 	dllGenLists                  =(unsigned int (APIENTRY *)(int))GPA( "glGenLists" );
	...
	qglGetError                  = 	dllGetError                  =(unsigned int (APIENTRY *)(void))GPA( "glGetError" );
...
//	qglGetTexLevelParameterfv    = 	dllGetTexLevelParameterfv    =(void (APIENTRY *)(unsigned int,int,unsigned int,float *))GPA( "glGetTexLevelParameterfv" );
//	qglGetTexLevelParameteriv    = 	dllGetTexLevelParameteriv    =(void (APIENTRY *)(unsigned int,int,unsigned int,int *))GPA( "glGetTexLevelParameteriv" );
